...
class AboutBeerViewController: UIViewController {
    ...
    @IBAction func SegmentControllerVolume(_ sender: UISegmentedControl) {
        ...
        case 0 : priceLabel.text = "Стоимость: \(beer.price.0) р."
        case 1 : priceLabel.text = "Стоимость: \(beer.price.1) р."
        case 2 : priceLabel.text = "Стоимость: \(beer.price.2) р."
        default : return
        }
        updateVolume()
    }
   ...
   private func fillBeer () {
        ...
        textAboutBeer.text = "\(beer.colorType)"
            ...
            priceLabel.text = "Стоимость: \(beer.price.0) р."
   ...
   private func updateVolume (){
    ...
    private func checkVolume () {
         buyBeer.isEnabled = getCurrentVolume() <= beer.volume
