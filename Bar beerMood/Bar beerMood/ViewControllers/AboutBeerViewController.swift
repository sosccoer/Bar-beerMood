...
class AboutBeerViewController: UIViewController {
    ...
    private func fillDefaultValues () {
        ...
        let currentBeer = BarManager.sharedInfo.beers[beerIndex]
   ...
   private func updateVolume (){
       VolumeLabel.text = "Остаток пива: \(BarManager.sharedInfo.beers[beerIndex].volume )"
       checkVolume ()
    }
    ...
    private func checkVolume () {
        ...
        buyBeer.isEnabled = getCurrentVolume() <= BarManager.sharedInfo.beers[beerIndex].volume
